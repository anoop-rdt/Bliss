...
from apps.ble.views import BLEDeviceViewSet, BLEDataViewSet, GatewayListView, GatewayDetailView

router = routers.SimpleRouter()
router.register('ble-device', BLEDeviceViewSet, base_name='ble-device')
router.register('ble-data', BLEDataViewSet, base_name='ble-data')
